...
function getRandomSound() {
    let songs =
        [
            { filename: "sounds/noise (1).mp3"},
            { filename: "sounds/noise (2).mp3"},
            { filename: "sounds/noise (3).mp3"},
            { filename: "sounds/noise (4).mp3"},
            { filename: "sounds/noise (5).mp3"},
            { filename: "sounds/noise (6).mp3"},
            { filename: "sounds/noise (7).mp3"}
        ];
